...
# BEAUTIFUL DARK MODE + FULLY VISIBLE UPLOAD BUTTONS
st.markdown("""
...
<p style='color:#b0b0ff; font-size:0.95rem;'></p>
</div>
""", unsafe_allow_html=True)
...
# FIXED FEATURES PAGE — NO EMPTY BLOCKS
elif page == "Features":
    st.markdown("<div class='header'>", unsafe_allow_html=True)
    ...
    for i, (title, icon, color) in enumerate(features):
        with cols[i]:
            ...
            <div class='feature-card'>
                ...
                <h4 style='color:#e0e0ff; margin-top:1rem;'>{title}</h4>
            </div>
            """, unsafe_allow_html=True)
